...
export const translations: Record<PatientLanguage, TranslationDictionary> = {
  ...
  te: {
    ...
    startTitle: "మీరు ప్రారంభించడానికి సిద్ధంగా ఉన్నారు.", startDescription: "మీరు చర్చించాలనుకుంటున్న విషయాలను డాక్టర్ అర్థం చేసుకోవడానికి మీ సమాధానాలు సహాయపడతాయి.", startNote: "మీ సందర్శనలోని తదుపరి భాగం తరువాతి దశలో చేర్చబడుతుంది.", languageStep: "భాష", consentStep: "సమ్మతి", startStep: "ప్రారంభం", complaintStep: "షికారు", anatomyStep: "ఎక్కడ బాధ", complaintTitle: "ఈరోజు మీకు ఏదైనా ఇబ్బంది ఉందా?", complaintPrompt: "ఈరోజు మీకు ఏదైనా ఇబ్బంది ఉందా?", complaintPlaceholder: "మీ ప్రధాన సమస్యను మీ మాటల్లో వివరించండి.", complaintVoiceReady: "వాయిస్-రెడీ ఇన్పుట్", complaintHelper: "ఇది కేవలం పేషెంట్ వివరణ మాత్రమే. మేము ఎటువంటి వ్యాధి నిర్ధారణ లేదా తీవ్రతను సూచించము.", complaintNext: "కొనసాగించండి", anatomyTitle: "మీకు ఇది ఎక్కడ అనిపిస్తోంది?", anatomyPrompt: "మీ ప్రధాన సమస్యకు అత్యంత సారూప్యమైన ప్రాంతాన్ని ఎంచుకోండి.", bodyFigureLabel: "శరీర ప్రాంతం ఎంపిక", regionListLabel: "శరీర ప్రాంతాల జాబితా", head: "తల", chest: "చెంచు", abdomen: "బొడ్డు/కడుపు", back: "వెనుక", arm: "చెయ్యి", hand: "చేయి", leg: "కాలు", foot: "చేయి/పాదం", skin: "చర్మం", other: "ఇతరాలు", front: "ముందు", upper: "ఎగువ", lower: "కింద", middle: "మధ్య", left: "ఎడమ", right: "కుడి", face: "ముఖం", body: "శరీరం", progressLabel: "ప్రారంభ పురోగతి", helpTitle: "సహాయం కావాలా?", helpDescription: "సహాయం కోసం దయచేసి సిబ్బంది సభ్యుడిని అడగండి. వాయిస్ సహాయం తరువాతి దశలో అందుబాటులో ఉంటుంది.", close: "మూసివేయండి", languageSaved: "భాష ఎంచుకోబడింది", loading: "MediKiosk లోడ్ అవుతోంది…", errorTitle: "ఏదో తప్పు జరిగిందిది.", errorDescription: "దయచేసి మళ్లీ ప్రయత్నించండి లేదా సిబ్బంది సహాయం అడగండి.", tryAgain: "మళ్లీ ప్రయత్నించండి",
  },
  ta: {
    ...english,
